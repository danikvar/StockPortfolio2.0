...
public class RebalancingWeights extends JFrame {
   ...
   * @param setter object.
   */
  public RebalancingWeights(Map<String, String> validStockMap, StockWeightsSetter setter) {

    Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
    this.setSize(600, 400);
    this.setLocation(dim.width / 2 - this.getSize().width / 2,
            dim.height / 2 - this.getSize().height / 2);
    this.setTitle("Rebalancing Stock Weights");
    this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    this.setResizable(false);
    JTable table = new JTable();

    Object[] columns = {"Stock Name", "Rebalanced Weight",};
    ...
    JLabel stockWeightLabel = new JLabel("Rebalanced Weight (%)");
    ...
    JButton validateAndCreate = new JButton("Rebalance and Create");

    stockNameLabel.setBounds(20, 220, 100, 25);
    stockWeightLabel.setBounds(20, 250, 150, 25);

    stockName.setBounds(155, 220, 100, 25);
    stockWeight.setBounds(155, 250, 100, 25);

    btnAdd.setBounds(275, 220, 100, 25);
    btnUpdate.setBounds(275, 265, 100, 25);
    btnDelete.setBounds(275, 310, 100, 25);
    validateAndCreate.setBounds(400, 310, 180, 25);
    ...
    btnAdd.addActionListener(e -> {
      ...
      // TODO: row[0] here are the stocks. Check whether its present in portfolio or not here.
